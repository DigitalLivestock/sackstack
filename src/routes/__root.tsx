...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free bag packing planner with weight tracking. Split items across bags, balance weight among carriers, and print your packing list. No tracking, no server storage." },
      { name: "author", content: "Sack Stack" },
      { property: "og:title", content: "Sack Stack | Free bag packing planner & weight tracker" },
      { property: "og:description", content: "Free bag packing planner with weight tracking. Split items across bags, balance weight among carriers, and print your packing list." },
