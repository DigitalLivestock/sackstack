...
function Footer() {
  return (
    <footer className="border-t border-border bg-background/50 print:hidden">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free bag packing planner with weight tracking. Balance every bag's weight before a trip. No tracking, no server storage." },
      { name: "author", content: "Sack Stack" },
      { property: "og:title", content: "Sack Stack | Free bag packing planner & weight tracker" },
      { property: "og:description", content: "Free bag packing planner with weight tracking. Balance every bag's weight before a trip." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Sack Stack" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@SackStack" },
      { name: "twitter:title", content: "Sack Stack | Free bag packing planner & weight tracker" },
      { name: "twitter:description", content: "Free bag packing planner with weight tracking. Split items across bags, balance weight among carriers, and print your packing list." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Sack Stack",
          description: "Free bag packing planner with weight tracking. Balance the weight of every bag, assign carriers, and print your packing list.",
