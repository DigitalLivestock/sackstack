...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Free packing planner with no tracking and no data stored on any server. Plan item weights across bags and carriers for any trip." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@SackStack" },
      { name: "twitter:title", content: "Sack Stack — free & private packing planner" },
      { name: "twitter:description", content: "Free packing planner with no tracking and no data stored on any server. Plan item weights across bags and carriers for any trip." },
