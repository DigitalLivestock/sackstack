...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sack Stack | Organize your Voyage" },
      { name: "twitter:description", content: "Sack Stack helps users plan and track item weights for trips, supporting multiple users and travel types." },
